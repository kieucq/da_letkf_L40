...
!
  call input_namelist(debug,ovar,bvar,model_flag,ini_flag,ifactor,nme,no,ne,nxl)
...
!  X(i)    = p(ip(m),jp(n)) 
  ...
  SUBROUTINE input_namelist(debug,ovar,bvar,model_flag,ini_flag,ifactor,nme,no,ne,nxl)
  INCLUDE "../L40.inc"
  RETURN
  END
